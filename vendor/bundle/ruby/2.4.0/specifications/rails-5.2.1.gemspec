...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 5.2.1"])
      s.add_runtime_dependency(%q<activejob>.freeze, ["= 5.2.1"])
      s.add_runtime_dependency(%q<actioncable>.freeze, ["= 5.2.1"])
      s.add_runtime_dependency(%q<activestorage>.freeze, ["= 5.2.1"])
      ...
      s.add_dependency(%q<actionmailer>.freeze, ["= 5.2.1"])
      s.add_dependency(%q<activejob>.freeze, ["= 5.2.1"])
      s.add_dependency(%q<actioncable>.freeze, ["= 5.2.1"])
      s.add_dependency(%q<activestorage>.freeze, ["= 5.2.1"])
